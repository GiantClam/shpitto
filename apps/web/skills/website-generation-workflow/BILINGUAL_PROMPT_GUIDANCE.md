...
- Language guidance: bilingual EN/ZH output now uses an English-first, i18n-ready first pass. Visible HTML should default to English, while alternate-language content lives in generated i18n files or other hidden resources.
...
- First-pass bilingual output is allowed to stay English-visible while shipping i18n resource files. Do not force simultaneous zh/en visibility just to prove the site is bilingual-capable.
...
- First-pass visible language for this file should be English unless the task explicitly asks for a different bootstrap locale. Chinese belongs in the i18n resources, not as duplicated visible fallback copy.
