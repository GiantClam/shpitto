    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p>
            By accessing our website at https://shpitto.com, you agree to be bound by these terms of service, all applicable laws and regulations, 
          ...
          <p>
            You retain ownership of the content you generate using Shpitto. 
            However, Shpitto retains ownership of the underlying AI models, templates, and software infrastructure used to generate that content.
          </p>
