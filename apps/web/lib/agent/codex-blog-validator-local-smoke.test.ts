...
const smokeProvider = String(process.env.SMOKE_LLM_PROVIDER || "aiberm").trim() || "aiberm";
const smokeProviderOrder = Array.from(new Set([smokeProvider, "aiberm", "pptoken", "crazyrouter"])).join(",");
