...
const copy = {
  en: {
    ...
    legal: "By creating an account, you agree to Shpitto's Terms of Service, Privacy Policy, and Acceptable Use Policy.",
  ...
  zh: {
    ...
    failedCreate: "创建账号失败。",
    legal: "创建账号即表示你同意 Shpitto 的服务条款、隐私政策和可接受使用政策。",
