...
export function LoginForm({ initialLocale }: { initialLocale: Locale }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[color-mix(in_oklab,var(--shp-bg)_92%,white_8%)] p-4">
      <div className="w-full max-w-md overflow-hidden rounded-2xl border border-[color-mix(in_oklab,var(--shp-border)_68%,transparent)] bg-white shadow-xl">
        <div className="p-8">
          <div className="mb-8 flex items-center gap-3">
            <Link href="/" className="-ml-2 rounded-full p-2 transition-colors hover:bg-[color-mix(in_oklab,var(--shp-primary)_10%,transparent)]">
          ...
          <h2 className="mb-2 text-2xl font-bold text-[var(--shp-text)]">{copy.welcome}</h2>
