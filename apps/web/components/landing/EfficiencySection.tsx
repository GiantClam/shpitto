import { LayoutTemplate, MessageSquare, Zap } from "lucide-react";
...
export function EfficiencySection({ locale = "en" }: { locale?: Locale }) {
  ...
  const flow = isZh ? ["简介", "页面", "预览", "上线"] : ["Brief", "Pages", "Preview", "Launch"];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mb-8 text-lg leading-relaxed text-[var(--shp-muted)]">{copy.body}</p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--shp-muted)]">{copy.features[0].description}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--shp-muted)]">{copy.features[1].description}</p>
                </div>
              </div>
            </div>
          </div>
